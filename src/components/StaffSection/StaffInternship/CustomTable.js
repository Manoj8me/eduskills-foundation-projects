...
// sections
import { UserListHead, UserListToolbar } from "../../common/user";
// mock
...
import TogglePage from "../../common/toggleButton/togglePage";
import CustomViewDrawer from "../../common/drawer/CustomViewDrawer";
// import InternViewDrawer from "../../common/drawer/InternViewDrawer";
    ...
    <>
                              ...
                              <Label
                                color={
                                  status === "Provisional"
                                    ...
                                    : status === "InProgress"
                                    ? "warning"
                                    :status === "Shortlist"? "secondary":"info"
                                }
                              >
                                {sentenceCase(status)}
                              </Label>
      ...
      >
        <MenuItem sx={{ color: "info.main" }} onClick={viewDrawerOpen}>
          ...
          <Typography sx={{ ml: 0.5, fontSize: 12, fontWeight:500}}>View Details</Typography>
        </MenuItem>

        <MenuItem disabled sx={{ color: "success.main" }} onClick={internshipDrawerOpen} >
          <Icon icon={"carbon:education"} />
          <Typography sx={{ ml: 0.5, fontSize: 12, fontWeight:500 }}>Internship</Typography>
        </MenuItem>
      </Popover>
      {/* <InternViewDrawer
